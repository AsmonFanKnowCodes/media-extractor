...
Keep the app shell branded Media Extractor. Use official, unchanged platform assets inside their corresponding tools; asset provenance lives in `extension/assets/README.md`. YouTube is currently the only implemented service. Add other services only when requested and implemented.
