...
Keep the app shell branded Media Extractor. Use official, unchanged platform assets inside their corresponding tools; asset provenance lives in `extension/assets/README.md`. YouTube, Instagram, X, Reddit, TikTok, Facebook, Pinterest and Threads are implemented. Add further services only when requested and implemented.
