...
- `youtube-logo.png`: unchanged `YouTube_Logo/Digital/01 Full Color/yt_logo_fullcolor_almostblack_digital.png` from the official package linked by [YouTube Brand / YouTube Logo](https://brand.youtube/youtube-logo). Download: https://www.gstatic.com/marketing-cms/52/7d/637fef5a4788a97747e6feabc4aa/youtube-logo.zip. Used to identify YouTube, without implying endorsement. Original colors, proportions, and built-in clear space are preserved.
